...
OpenAPI-снимки и внешние схемы: [`openapi/`](openapi/README.md).
...
Операции с промптами агентов: см. таблицу в `docs/agents/langgraph.md` (`/api/ops/agents`).
...
| Method | Path | Описание |
|--------|------|----------|
| GET | `/api/tenders/search` | Поиск тендеров (несколько источников, см. `docs/modules/tenders.md`) |
...
Полное описание провайдеров и env: **`docs/modules/tenders.md`**.

---

## См. также

- Полный операционный контекст: `docs/start/RUNBOOK.md`

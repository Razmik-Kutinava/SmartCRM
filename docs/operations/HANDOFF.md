...
`Спринт:[Фаза 1→2] | Задача:[MAP DoD Ф1] | Статус:DoD фазы 6 критериев, вердикт 4/6 + ⚠️ микрофон ✅`
...
**Следующий MAP-doc (тащим):** дубль «Поиск и RAG»; шапки «чеклист = таблица» в Лиды/Баллы/Поиск; п.5 сценарии (уже есть — не дублировать).

...
`Спринт:[Фаза 1→2] | Задача:[MAP статусы ⚠️] | Статус:легенда + голос + сводка синхронизированы ✅`
...
**Следующий MAP-doc (тащим):** убрать дубль списка в «Поиск и RAG»; шапки «чеклист = таблица ниже» в Лиды/Баллы/Поиск; п.4 DoD / п.5 сценарии (если ещё не закрыты).

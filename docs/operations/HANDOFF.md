...
`Спринт:[Фаза 1→2] | Задача:[MAP хвост Ф1] | Статус:устаревший «Хвост Фазы 1» убран; открытые хвосты → только BACKLOG ✅`
...
**Следующий MAP-doc (тащим):** убрать дубль списка в «Поиск и RAG»; шапка «чеклист = таблица ниже»; пункт 3 статусы ⚠️ (сводка).

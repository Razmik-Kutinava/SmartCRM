...
`Спринт:[Фаза 1→2] | Задача:[MAP п.7–10] | Статус:агенты quality gates, безопасность, инфра прод, coverage ✅`
...
**MAP-doc (остаток):** дубль «Поиск и RAG»; шапки «чеклист = таблица» в Лиды/Баллы/Поиск. П.7–10 (агенты, security, infra прод, coverage) — **закрыты**.

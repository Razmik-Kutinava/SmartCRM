...
`Спринт:[Фаза 1→2] | Задача:[MAP сценарии Ф1] | Статус:7 бизнес-сценариев + процесс «сценарий → таблица» ✅`
...
**Следующий MAP-doc (тащим):** дубль «Поиск и RAG»; шапки «чеклист = таблица» в Лиды/Баллы/Поиск; п.6 порядок Ф2 (уже частично).

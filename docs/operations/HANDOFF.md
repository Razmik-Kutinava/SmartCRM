...
`Спринт:[Фаза 1→2] | Задача:[MAP порядок Ф2] | Статус:очередь 1–9, фундамент/можно позже, §1 ≠ лиды Ф1 ✅`
...
**Следующий MAP-doc (тащим):** дубль «Поиск и RAG»; шапки «чеклист = таблица» в Лиды/Баллы/Поиск.

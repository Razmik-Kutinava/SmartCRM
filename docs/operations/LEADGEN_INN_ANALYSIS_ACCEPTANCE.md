...
## ✅ СДЕЛАНО и ПРОВЕРЕНО (DevTools 2026-06-10)

| # | Шаг | Результат |
|---|-----|-----------|
| 1 | ИНН `5040048921` (Хохланд Руссланд) | Карточка: ИНН, название, ОКВЭД пищевка, скор, сайт `hochland.ru` |
| 2 | Checko ЕГРЮЛ | Название, ОГРН, адрес, ОКВЭД |
...
| 6 | Название «Яндекс» (без ИНН) | Checko → МКПАО ИНН `3900019850`, скор **71**, ~58 с (отдельный кейс) |
| 7 | Ссылки сайта после fix | `https://hochland.ru/` — без двойного `https://` |

*Исторический прогон 2026-06-08 со Сбером `7707083893` заменён — live-канон leadgen: Хохланд (`inn_constants.py`).*
...
|--------|---------|------------|
| Выручка «—» у части компаний | финансы | Checko/FNS без полного ключа или закрытая отчётность |
| BuiltWith 0 tech на части сайтов | tech stack | WAF / блок сканера |
